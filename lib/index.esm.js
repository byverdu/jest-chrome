 ...
 */
const makeAsyncMock = (callbackArgIndex) => jest
    .fn()
...
const addFunction = ({ name, parameters }, target) => {
    var _a, _b;
    const fn = (parameters === null || parameters === void 0 ? void 0 : parameters.length) &&
        ((_a = parameters[parameters.length - 1]) === null || _a === void 0 ? void 0 : _a.name) === 'callback' &&
        ((_b = parameters[parameters.length - 1]) === null || _b === void 0 ? void 0 : _b.type) === 'function'
